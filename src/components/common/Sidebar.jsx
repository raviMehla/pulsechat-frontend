      ...
      <div className="flex md:flex-col items-center gap-2 md:gap-6 w-full md:w-auto justify-around md:justify-start">
        ...
        <NavLink to="/status" className={navClass} title="Status">
          <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
            <path d="M12 2a10 10 0 0 1 10 10" strokeDasharray="4 3" />
            <path d="M22 12a10 10 0 0 1-10 10" strokeDasharray="4 3" />
            <path d="M12 22A10 10 0 0 1 2 12" strokeDasharray="4 3" />
            <path d="M2 12A10 10 0 0 1 12 2" strokeDasharray="4 3" />
